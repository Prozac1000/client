    ...
    return (
      <React.Fragment>
        ...
        <div className="container">
          ...
          />
          <button className="btn btn-light btn-outline-dark" onClick={this.toggleDisplay}>       
            {isDisplay ? (
              <FontAwesomeIcon title="Table Mode" icon={faTableList} /> 
            )  : (
              <FontAwesomeIcon title="Grid Mode" icon={faTableCellsLarge} />
            )}
          </button>
          {!isDisplay ? ( 
            <Cards
