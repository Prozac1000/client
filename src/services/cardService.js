...
export const changeLikeStatus = async cardId => http.patch(`${apiUrl}/cards/card-like/${cardId}`);

export const getFavoriteCards = () => http.get(`${apiUrl}/cards/my-favorite-cards`);
